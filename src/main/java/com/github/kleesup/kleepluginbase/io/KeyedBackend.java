...
/**
 * An implementation of {@link Backend} which provides the functionality of setting and getting
 * values in a key-value style.
 */
public interface KeyedBackend<K, V> extends Backend {
